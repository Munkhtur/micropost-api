...
function getPosts() {
  _http.http.get('/api/posts').then(function (data) {
...
function submitPost(e) {
  ...
  if (title === '' || body === '') {
    _ui.ui.showAlert('Please fill in form', 'alert alert-danger');
  } else {
    if (id === '') {
      _http.http.post('/api/posts', data).then(function (data) {
        if (data.error) {
          _ui.ui.showAlert('' + data.error, 'alert alert-danger');
        } else {
      ...
      _http.http.put('/api/posts/' + id, data).then(function (data) {
...
function deletePost(e) {
  ...
  if (e.target.parentElement.classList.contains('delete')) {
    ...
    if (confirm('Are you sure?')) {
      _http.http.delete('/api/posts/' + id).then(function (data) {
...
var UI = function () {
  ...
  _createClass(UI, [{
    ...
    value: function clearAlert() {
      var currentAlrt = document.querySelector('.alert');
      if (currentAlrt) {
        currentAlrt.remove();
      }
    }
